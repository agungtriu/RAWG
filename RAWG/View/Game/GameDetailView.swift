...
struct GameDetailView: View {
    ...
    var genre: some View {
        Group {
            ...
            Text(gameDetailViewModel.gameDetail.genres.dropLast(2))
    ...
    var developers: some View {
        Group {
            Text("Developers")
                ...
                .foregroundColor(Color(hex: 0xA8A8A8))
                .padding(EdgeInsets(top: 0, leading: 16, bottom: 4, trailing: 16 ))
            Text(gameDetailViewModel.gameDetail.developers.dropLast(2))
                .font(Font.custom("Mulish-Regular", size: 15))
                .foregroundColor(.white)
                .padding(EdgeInsets(top: 0, leading: 16, bottom: 8, trailing: 16 ))
        }
    ...
    var publishers: some View {
        Group {
            Text("Publishers")
                ...
                .foregroundColor(Color(hex: 0xA8A8A8))
                .padding(EdgeInsets(top: 0, leading: 16, bottom: 4, trailing: 16 ))
            Text(gameDetailViewModel.gameDetail.publishers.dropLast(2))
                .font(Font.custom("Mulish-Regular", size: 15))
                .foregroundColor(.white)
                .padding(EdgeInsets(top: 0, leading: 16, bottom: 8, trailing: 16 ))
        }
